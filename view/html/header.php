  ...
  <body>
    ...
    <?php if(!isset($_SESSION['users_id']) or $_SESSION['users_id'] == ''){ ?>
      <div class="bloc_login">
        <a href="#" class="bt vert">Create Account</a>
        <a href="#" class="bt gris">Sign In</a>
      </div>

    <?php } else { ?>

      <div class="bloc_user"><a href="?appli=users&action=account" class="user_name"><?php echo $_SESSION['users_name'].' '.$_SESSION['users_firstname']; ?></br><span>View Profil</span></a><a href="?appli=users&action=account" class="image"><img href="?appli=users&action=account" src="assets/img/img_chef.png"></a></div>
    ...
    <div class="signup">
        ...
        <div class="else">Or you can sign in with socials medias!</div>
    </div>
