	...
	<div>
		<h1 style="color:#89B929;">Create my book</h1>
			<form id="create_book" name="book" action="?appli=home&action=book" method='post'>
				<p style="color:white; margin:5px;">Name of my book</p>
					<input style="border-radius:10px;" class="book_name" type="text" name="book_name" maxlength="100"><br/>	
				  	<button style="margin-top:5px;" class="bt vert" type="submit">Create</button>
			</form>
	</div><br/>
