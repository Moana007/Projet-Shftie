<?php if($_GET['preview']){ ?>
  ...
  <!-- BOUTON DE PARTAGE  -->
    ...
    <div id="slider_recipe">
        <div class="onglet_1">
          <?php foreach($therecipe as $zerecipe): ?>
          <div style="background: url('<?php echo $zerecipe['photo']; }?>') center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover;background-size: cover;" class="image">
            <a href="http://shiftie.org/construction.html"><!-- <img  src="<?php echo $zerecipe['photo']; }?>"> --></a>
